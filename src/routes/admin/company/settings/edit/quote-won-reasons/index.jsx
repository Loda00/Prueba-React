...
class QuoteWonReasons extends Component {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    if (nextProps.retrieved && nextProps.retrieved['hydra:member'][0].name === 'QUOTE_WON_REASONS' && !prevState.isSettingsLoaded) {
      return {
      ...
      <div className="section-container">
        <div className="section-general">
          <div className="option-buttons-container clearfix">
            ...
            <EssorButton as={Link} to="/company/settings/quote-won-reasons" type="chevron left" size="tiny" floated="right">
              {t('buttonBack')}
            </EssorButton>
          </div>
          <Grid>
