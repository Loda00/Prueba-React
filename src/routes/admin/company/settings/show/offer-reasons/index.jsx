...
class OfferReasons extends Component {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    if (
      ...
      && nextProps.retrieved['hydra:member'][0].name === 'OFFER_REASONS'
    ) {
      return {
      ...
      <div className="section-container">
        <div className="section-general">
          <div className="option-buttons-container clearfix">
            ...
            <EssorButton as={Link} to="/company/settings/offer-reasons/edit" type="edit" size="tiny" floated="right">
              {t('buttonEdit')}
            </EssorButton>
          </div>
          ...
          >
            ...
            <Table celled striped>
              ...
              <Table.Body>
                {value && value.map((offerReason, index) => (
