...
class ContractTypes extends Component {
  ...
  componentDidMount() {
    ...
    retrieve(`/company_settings?company=${selectedCompany.id}&name=CONTRACT_TYPE`);
  }
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    if (nextProps.retrieved && nextProps.retrieved['hydra:member'][0].name === 'CONTRACT_TYPE' && !prevState.isSettingsLoaded) {
      return {
      ...
      <div className="section-container">
        <div className="section-general">
          <div className="option-buttons-container clearfix">
            <Header as="h3">{t('companiesContractTypes')}</Header>
            <EssorButton as={Link} to="/company/settings/contract-types" type="chevron left" size="tiny" floated="right">
              {t('buttonBack')}
            </EssorButton>
          </div>
          <Grid>
...
const Main = connect(mapStateToProps, mapDispatchToProps)(ContractTypes);
